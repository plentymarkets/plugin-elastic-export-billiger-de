...
# Elastic Export billiger.de Plugin for plentymarkets 7

This is the elastic export billiger.de plugin for plentymarkets 7 which extends the list of possible export formats. 
